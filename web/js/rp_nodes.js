/**
 * ComfyUI_RP_Cast - Frontend Extension v0.5.59
 */
...
app.registerExtension({
    ...
    settings: [
        {
            id:           "ComfyUI-RP-Cast.Configuration.openai_api_key",
            name:         "openai_api_key",
            type:         "text",
            defaultValue: "",
            tooltip:      "OpenAI API key for RP Txt2Img (OpenAI) node. Starts with sk-...",
            category:     ["ComfyUI-RP-Cast", "Configuration", "openai_api_key"],
            attrs:        { style: { fontFamily: "monospace" } },
        },
        {
            id:           "ComfyUI-RP-Cast.Configuration.gemini_api_key",
            name:         "gemini_api_key",
            type:         "text",
            defaultValue: "",
            tooltip:      "Google AI Studio API Key for RP Txt2Img (Gemini). 발급: https://aistudio.google.com/apikey",
            category:     ["ComfyUI-RP-Cast", "Configuration", "gemini_api_key"],
            attrs:        { style: { fontFamily: "monospace" } },
        },
        {
            id:           "ComfyUI-RP-Cast.Configuration.grok_api_key",
            name:         "grok_api_key",
            type:         "text",
            defaultValue: "",
            tooltip:      "xAI Grok API key for RP Txt2Img (Grok) node.",
            category:     ["ComfyUI-RP-Cast", "Configuration", "grok_api_key"],
            attrs:        { style: { fontFamily: "monospace" } },
        },
    ],
